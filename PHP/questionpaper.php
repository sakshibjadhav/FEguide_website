...
<header>
    ...
    <div class="container">
        ...
        <option value="Applied Maths1">Applied Maths 1</option>
        ...
        <option value="Applied Maths 2">Applied Maths 2</option>
    ...
    $db=mysqli_select_db($con,'fe_guide');
   
    //echo "connection was successful";
    if(isset($_POST['btn']))
    {
        $id=$_POST['search'];
        $query="SELECT * FROM `question_papers` where subject='$id' ";
    ...
    {
        ?>
        <br><br><br><a href="<?php echo $row['dec19'];?>">DEC19</a><br>
        <a href="<?php echo $row['may19'];?>">MAY19</a><br>
        <a href="<?php echo $row['dec18'];?>">DEC18</a><br>
        <a href="<?php echo $row['may18'];?>">MAY18</a><br>
        <a href="<?php echo $row['dec17'];?>">DEC17</a><br>
        <a href="<?php echo $row['may17'];?>">MAY17</a><br>
        <a href="<?php echo $row['dec16'];?>">DEC16</a><br>
        <a href="<?php echo $row['may16'];?>">MAY16</a><br>
        <a href="<?php echo $row['dec15'];?>">DEC15</a><br>
        <a href="<?php echo $row['may15'];?>">MAY15</a><br>
        <a href="<?php echo $row['dec14'];?>">DEC14</a><br>
        <a href="<?php echo $row['may14'];?>">MAY14</a><br>
        <a href="<?php echo $row['dec13'];?>">DEC13</a><br>
        <a href="<?php echo $row['may13'];?>">MAY13</a><br>
        <a href="<?php echo $row['dec12'];?>">DEC12</a><br>
        <a href="https://drive.google.com/drive/folders/1X1nL_RI5l86eKPUSe-2GkWzMThd33jQY">FAQs</a>
        <?php
    }
    ?>
    </div>
